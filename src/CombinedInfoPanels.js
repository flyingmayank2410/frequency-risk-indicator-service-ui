...
function SwitchgearTypePanel({ data }) {
  ...
  return (
    <div style={styles.panel}>
      <h3 style={styles.panelHeader}>Switchgear Type Info</h3>
...
function FeederTypePanel({ data }) {
  ...
  return (
    <div style={styles.panel}>
      <h3 style={styles.panelHeader}>Feeder Type Info</h3>
...
function WindMillTypePanel({ data }) {
  ...
  return (
    <div style={styles.panel}>
      <h3 style={styles.panelHeader}>Wind Mill Type</h3>
      <p><b>Rated:</b> {rated}</p>
...
function SolarPanelTypePanel({ data }) {
  ...
  return (
    <div style={styles.panel}>
      <h3 style={styles.panelHeader}>Solar Panel Type</h3>
