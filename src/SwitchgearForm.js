...
function SwitchgearForm({ switchgear, onRefresh, onBack }) {
  ...
  const [form, setForm] = useState(
    switchgear || {
      swgName: "", incomerFeeder: 0, outgoingFeeder: 0, activeIncomerFeeder: 0, activeOutgoingFeeder: 0, locationId: switchgear.locationId || ""
    }
  );
  ...
  return (
    <form onSubmit={handleSubmit}>
      ...
      <input name="locationId" type="number" value={form.locationId} onChange={handleChange} placeholder="Location Id" readOnly={!!switchgear.locationId}/>
